...
- [ ] ACPI/DT CPU discovery
- [ ] struct cpu
- [ ] cpu_current()
- [ ] x86 GS per-CPU
- [ ] ARM64 TPIDR_EL1 per-CPU
- [ ] x86 AP trampoline
- [ ] ARM64 secondary CPU startup
- [ ] INIT/SIPI
- [ ] CPU startup handshake
- [ ] AP initialization
- [ ] CPU_ONLINE
- [ ] generic IPI API
- [ ] x86 LAPIC IPI backend
- [ ] ARM64 GIC IPI backend
- [ ] IPI_RESCHEDULE
- [ ] per-CPU runqueues
- [ ] scheduler on all CPUs
- [ ] cpu_call()
- [ ] IPI_CALL
- [ ] TLB shootdown
- [ ] IPI_TLB
